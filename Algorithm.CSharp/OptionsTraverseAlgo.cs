...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class OptionsTraverseAlgo : QCAlgorithm, IRegressionAlgorithmDefinition
    {
		...
		private void Consolidator_DataConsolidated(object sender, TradeBar e)
		{
			if (IsMarketOpen(Underlying) && _lastSlice != null)
			{
				...
				*/
				...
				if (!_Strategy.IsInvested && _rocp.Current.Value*100 >= _ROC_THRESHOLD)
				{
